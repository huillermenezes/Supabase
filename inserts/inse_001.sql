...
INSERT INTO public.leiaute_campo_arquivo (
	...
	, ('Numero da Parcela relacionada', (SELECT id FROM public.leiaute_arquivo WHERE denominacao = 'retorno_cartao_bradesco' AND tipo_arquivo = 2 LIMIT 1), 3, 75, 3, 1, 3, FALSE, NULL, NULL, 'numero_parcela_relacionada', 'cartao_bradesco')
	, ('Numero de Parcelas', (SELECT id FROM public.leiaute_arquivo WHERE denominacao = 'retorno_cartao_bradesco' AND tipo_arquivo = 2 LIMIT 1), 3, 78, 2, 1, 3, FALSE, NULL, NULL, 'numero_parcelas', 'cartao_bradesco')
	...
	, ('Valor da Transacao', (SELECT id FROM public.leiaute_arquivo WHERE denominacao = 'retorno_cartao_bradesco' AND tipo_arquivo = 2 LIMIT 1), 3, 80, 13, 2, 2, FALSE, NULL, NULL, 'valor_transacao', 'cartao_bradesco')
